			...
			<div class="join">
				...
				<div id="info_pemail">
					<input type="email" id="pemail" name="pemail"
						placeholder="nearbydoc@abc.com 형식으로 입력" required>
					<button id="pemailcheck">중복 확인</button>
				</div>
				<br> 비밀번호<br>
				<div class="input-container">
					<input type="password" id="ppassword" name="ppassword" placeholder="" required /> <span
						class="icon material-symbols-outlined"> lock </span>
				</div>
				비밀번호 재확인<br>
				<div class="input-container">
					<input type="password" placeholder="" required /> <span
						class="icon material-symbols-outlined"> lock </span>
				</div>
				이름<br> 
				<input type="text" id="pname" name="pname" placeholder="" required />
				휴대전화<br> 
				<input type="number" id="ptel" name="ptel" placeholder="-없이 숫자만 입력" /> 
					주민번호<br> 
					<input type="number" id="pidnum" name="pidnum" placeholder="-없이 숫자만 입력" required /> 주소<br>
				<div class="row">
					<div class="input">
